...
public class ClientDemographicsUpdated extends DomainEvent {
    private final UUID clientId;
    private final HumanName name;
    private final AdministrativeGender gender;
    private final LocalDate birthDate;

    public ClientDemographicsUpdated(UUID clientId, HumanName name, AdministrativeGender gender, LocalDate birthDate, Instant occurredAt) {
